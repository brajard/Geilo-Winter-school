...
\title[Machine Learning]{Machine learning and physical modelling}
...
\centering
  \begin{tikzpicture}[scale=0.9]
    ...
    \draw<1-> {(0.6,0.6) ellipse (3 and 2)};
...
\column{.5\textwidth}
 \pause[4]
\begin{figure}
\includegraphics[width=.95\textwidth]{fig/L1/progress-papers.png}
\end{figure}
 \pause[5]
\column{.5\textwidth}
...
\end{figure}
\visible<2->{\alert{Mostly unknown dynamic processes}}

\column{.5\textwidth}
\begin{figure}
    \includegraphics[width=\textwidth]{fig/L1/evolution-temperature.png}
\end{figure}
\visible<2->{\alert{Mostly known dynamic processes (based on physical principles)}}
...
\begin{frame}
\frametitle{Presentation of the Data Challenge}
\begin{block}{Credits}
Data challenge designed by Sophie Giffard-Roisin (
University of Colorado, Boulder)\\
\href{mailtosophie.giffard@colorado.edu}{sophie.giffard@colorado.edu}\\
Tusen takk!!
\end{block}

\begin{itemize}
	\item One machine learning problem on climate
	\item Teams of 3/4 (please fill the form sent by mail if you did not!)
 	\item Evaluation metric: leaderboard on hidden data
	\item Online submissions of python code \\

\end{itemize}

\textit{Big thank to the Paris-Saclay CDS team (Balázs Kégl \& Alexandre Boucaud)}

\textbf{Friday Noon: Final results!}\\
...
\frametitle{Get yourself ready!}
\begin{itemize} 
\item \url{http://github.com/ramp-kits/storm_forecast} :
notebook .ipynb for all informations
 \item clone starting kit ('git clone ...') / download data
 \item \url{www.ramp.studio}: create account! (wait for access)
 \item \url{www.ramp.studio/problems/storm_forecast} :
...
\subsection{Pipeline and Submissions}

\begin{frame}

\frametitle{Pipeline: your work!}
\begin{figure}
	\includegraphics[width=0.95\linewidth]{fig/L1/pipeline.png} \\
\end{figure}
...
\setlength\itemsep{2em}
 \item Description: \url{http://github.com/ramp-kits/storm_forecast}  
 
 \item Submissions: \url{www.ramp.studio/problems/storm_forecast} 
  
 \item  Available on the server: scikitlearn, pytorch, keras ... look at \url{ami_environment.yml} file (only CPUs)\\
...
\item \url{http://github.com/ramp-kits/storm_forecast} :
notebook .ipynb for all informations
 \item clone starting kit (git) / download data
 \item \url{www.ramp.studio}: create account! (wait for access)
 \item \url{www.ramp.studio/problems/storm_forecast} :
		 register on the project!
 \item Submit to the ‘sandbox’ (copy/paste your code) \\
\end{itemize}
